...
class TimeUtilsTest {
  ...
  void testToTimestampAtStartOfDay() {
    ...
    var actual = TimeUtils.toTimestampAtStartOfDay(date);
  ...
  void testToTimestampAtEndOfDay() {
    ...
    var actual = TimeUtils.toTimestampAtEndOfDay(date);
  ...
  void testToTimestampAtEndOfDayWithTimestamp() {
    ...
    var actual = TimeUtils.toTimestampAtEndOfDay(timestamp);
  ...
  void testToISOFormat() {
    ...
    var actual = TimeUtils.toUtcDate(timestamp);
